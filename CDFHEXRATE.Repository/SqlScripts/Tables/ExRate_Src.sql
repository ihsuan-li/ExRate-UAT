/*
 ...
 Date: 05/03/2025 09:43:49
*/


-- ----------------------------
-- Table structure for ExRate_Src
-- ----------------------------
IF EXISTS (SELECT * FROM sys.all_objects WHERE object_id = OBJECT_ID(N'[dbo].[ExRate_Src]') AND type IN ('U'))
	DROP TABLE [dbo].[ExRate_Src]
GO

CREATE TABLE [dbo].[ExRate_Src] (
...
ALTER TABLE [dbo].[ExRate_Src] SET (LOCK_ESCALATION = TABLE)
GO
...
-- ----------------------------
-- Primary Key structure for table ExRate_Src
-- ----------------------------
ALTER TABLE [dbo].[ExRate_Src] ADD CONSTRAINT [PK_ExRate_Src] PRIMARY KEY CLUSTERED ([DataDate], [ExRateType], [ReferenceCurrency])
